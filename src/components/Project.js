    ...
    return (
        ...
        <div class="container mx-auto px-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-4">
            <a href="#" class="flex flex-col bg-white rounded-lg overflow-hidden shadow-md">
              <img src="https://via.placeholder.com/640x360.png" alt="" class="w-full h-48 object-cover"/>
